[![Java CI with Maven](https://github.com/GlizzyHacker/se-lab/actions/workflows/maven.yml/badge.svg)](https://github.com/GlizzyHacker/se-lab/actions/workflows/maven.yml)
